...
import { Home, Compass, Search, Library, Heart, Mic, History, CreditCard, User, HelpCircle, ShieldCheck, FileText, RotateCcw, XCircle, Mail, ReceiptText } from "lucide-react";

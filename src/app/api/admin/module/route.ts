...
const map: Record<string, string[]> = {
  content: ["tracks", "albums", "artists", "podcasts", "episodes"], "audio-sources": ["audioSources"], users: ["users"], roles: ["roles"], payments: ["payments", "orders"], subscriptions: ["subscriptions"], plans: ["plans"], moderation: ["reports", "moderationQueue"], reports: ["reports"], security: ["securityEvents"], logs: ["auditLogs", "webhookEvents"], system: ["systemConfig"], database: ["users", "tracks", "orders", "payments"], health: ["users", "tracks", "orders"], notifications: ["notifications"], maintenance: ["systemConfig"],
};
